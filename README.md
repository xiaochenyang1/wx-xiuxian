...
- 炼丹房支持四类配方，消耗材料与灵石炼制小经验丹、大经验丹、双修丹和突破丹
- 炼器室支持五类法宝定向打造，洞府等级改善品质概率，产物带品质与挂机词条
- 三位道侣可选其一结缘，消耗双修丹提升至 Lv.10，道侣加成进入统一挂机结算
- 三个本地宗门可选其一加入，通过物资捐献提升至 Lv.10 并获得持续加成
- 六关顺序历练，以当前总战力挑战并领取一次性首通奖励
...
当前没有账号、云存档、跨设备同步、在线排行榜、服务端防作弊、支付或运营后台。清理浏览器数据、删除微信小游戏或更换设备会丢失本地进度。
...
- 离线掉落、任务奖励、背包、功法、法宝、洞府、炼丹炼器产物、伴侣、宗门和历练进度与角色快照一起保存。
