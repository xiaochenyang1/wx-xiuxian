...
《我的修仙日记》是一款使用 Cocos Creator 3.8.8 开发的竖屏修仙放置小游戏。当前仓库处于第一阶段核心循环收尾期，已经接通本地客户端、Fastify 服务端、PostgreSQL 持久化和 Redis 健康检查，发布目标为微信小游戏。
...
- 正式 30 秒 heartbeat、版本化权威快照缓存、断网冷启动只读预览及 Cocos 前后台自动同步
